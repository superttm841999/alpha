...
import com.example.alpha.databinding.FragmentAccountListBinding
    ...
    override fun onCreateView(
        ...
        val adapter = UserAdapter() { holder, user ->
            holder.root.setOnClickListener {
                nav.navigate(R.id.accountListEditFragment, bundleOf("id" to user.id) )
            }
...
//                            nav.navigateUp()
        ...
        var dialog = AlertDialog.Builder(requireActivity())
            ...
            .setPositiveButton("OK", DialogInterface.OnClickListener { dialogInterface, i ->
                userDB.document(user.id).delete()
                    .addOnSuccessListener {
                        activity?.let{it -> "Delete User(${user.username}) Successfully".showToast(it)}
                    }
                    .addOnFailureListener {
    ...
    private fun deleteMultipleDialog(list: List<LUser>){
        ...
        var dialog = AlertDialog.Builder(requireActivity())
            ...
            .setMultiChoiceItems(items, checkedItems, DialogInterface.OnMultiChoiceClickListener{ _, i, isChecked ->
